...
import pl.itcrowd.seam3.persistence.conditions.FakeParameter;
import pl.itcrowd.seam3.persistence.conditions.FreeCondition;
import pl.itcrowd.seam3.persistence.conditions.OrCondition;
import pl.itcrowd.seam3.persistence.mocks.ElContextMock;
import pl.itcrowd.seam3.persistence.mocks.ExpressionFactoryMock;
...
// --------------------------- CONSTRUCTORS ---------------------------
        ...
        private CustomQuery()
        {
            ...
            try {
                Field expressions = pl.itcrowd.seam3.persistence.Query.class.getDeclaredField("expressions");
